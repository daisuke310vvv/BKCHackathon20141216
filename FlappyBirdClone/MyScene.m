...
-(id)initWithSize:(CGSize)size {    
    if (self = [super initWithSize:size]) {
        ...
        // 鳥の生成/設定
        /* -------------------------------------------- */
        SKTexture* birdTexture1 = [SKTexture textureWithImageNamed:@"Bird1_"];
        birdTexture1.filteringMode = SKTextureFilteringNearest;
        SKTexture* birdTexture2 = [SKTexture textureWithImageNamed:@"Bird2_"];
        ...
        // 地面の生成/設定
        /* -------------------------------------------- */
        SKTexture* groundTexture = [SKTexture textureWithImageNamed:@"ground_"];
        groundTexture.filteringMode = SKTextureFilteringNearest;
        
        CGFloat groundWidth = 36;
        
        SKAction* moveGroundSprite = [SKAction moveByX:-groundWidth*2 y:0 duration:0.02 * groundWidth*2];
        SKAction* resetGroundSprite = [SKAction moveByX:groundWidth*2 y:0 duration:0];
        SKAction* moveGroundSpritesForever = [SKAction repeatActionForever:[SKAction sequence:@[moveGroundSprite, resetGroundSprite]]];

        for( int i = 0; i < 2 + self.frame.size.width / ( groundWidth * 2 ); ++i ) {
            // Create the sprite
            SKSpriteNode* sprite = [SKSpriteNode spriteNodeWithTexture:groundTexture];
            sprite.size = CGSizeMake(groundWidth, 48);
            [sprite setScale:2.0];
        ...
        // パイプ
        /* -------------------------------------------- */
        _pipeTexture1 = [SKTexture textureWithImageNamed:@"Pipe1_"];
        _pipeTexture1.filteringMode = SKTextureFilteringNearest;
        _pipeTexture2 = [SKTexture textureWithImageNamed:@"Pipe2_"];
